...
const { getCountryCode2 } = require("../../utils/process/helpers.js");
...
module.exports = {
    ...
    callback: async (client, interaction) => {
        try {
            ...
            if (numericMonth === 2 && numericYear % 4 === 0 && (numericYear % 100 !== 0 || numericYear % 400 === 0)) {
                daysInMonth[2] = 29;
            }
            ...
            updatedMsg.content = "✅ DOB and region updated successfully!";
            ...
            try {
                ...
                if (!interaction.replied && !interaction.deferred) {
                    await interaction.reply({
                        content: "❌ An error occurred while processing your DOB change.",
                        ephemeral: true
                    });
                }
            }
