...
module.exports = async (axios, formatedemail) => {
  try {
    const firstUrl = 'https://login.live.com/oauth20_authorize.srf?client_id=81feaced-5ddd-41e7-8bef-3e20a2689bb7'
    ...
    const jwt = axios.getCookie("AMCSecAuthJWT");
    return jwt || false;
  } catch (err) {
