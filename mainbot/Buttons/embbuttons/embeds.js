...
const verificationMessage = require("../../../autosecure/utils/responses/verificationMessage");
...
let disableautosecure = {
    ...
    callback: async (client, interaction) => {
        ...
        let response = await verificationMessage(client, interaction.user.id, type, botnumber);
